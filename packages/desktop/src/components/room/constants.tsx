...
export const IMAGE_THEMES: ImageTheme[] = [
  ...
  // ── Chiikawa (Live) ──
  { id: 'live:chiikawa_1', name: 'Chiikawa 1', category: 'live', isVideo: true, video: './themes/live/chiikawa-1.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-1.mp4', isLight: true, textColor: '#0F172A', accentColor: '#92400e', glassColor: 'rgba(236,235,219,0.50)', menuBg: 'rgba(246,245,229,0.84)' },
  { id: 'live:chiikawa_2', name: 'Chiikawa 2', category: 'live', isVideo: true, video: './themes/live/chiikawa-2.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-2.mp4', isLight: true, textColor: '#0F172A', accentColor: '#b45309', glassColor: 'rgba(228,206,175,0.50)', menuBg: 'rgba(238,216,185,0.84)' },
  { id: 'live:chiikawa_3', name: 'Chiikawa 3', category: 'live', isVideo: true, video: './themes/live/chiikawa-3.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-3.mp4', isLight: true, textColor: '#0F172A', accentColor: '#64748b', glassColor: 'rgba(227,228,228,0.50)', menuBg: 'rgba(237,238,238,0.84)' },
  { id: 'live:chiikawa_4', name: 'Chiikawa 4', category: 'live', isVideo: true, video: './themes/live/chiikawa-4.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-4.mp4', isLight: true, textColor: '#0F172A', accentColor: '#0d9488', glassColor: 'rgba(183,222,223,0.50)', menuBg: 'rgba(193,232,233,0.84)' },
  { id: 'live:chiikawa_5', name: 'Chiikawa 5', category: 'live', isVideo: true, video: './themes/live/chiikawa-5.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-5.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#a3e635', glassColor: 'rgba(27,36,10,0.60)', menuBg: 'rgba(37,46,20,0.80)' },
  { id: 'live:chiikawa_6', name: 'Chiikawa 6', category: 'live', isVideo: true, video: './themes/live/chiikawa-6.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-6.mp4', isLight: true, textColor: '#0F172A', accentColor: '#65a30d', glassColor: 'rgba(212,244,151,0.50)', menuBg: 'rgba(222,254,161,0.84)' },
  // ── Moon ──

...
export const IMAGE_THEMES: ImageTheme[] = [
  // ── Live Video Themes ──
  { id: 'live:imperial', name: 'Imperial Rest', category: 'live', isVideo: true, video: './themes/live/imperial-rest.mp4', thumbnailVideo: './themes/live/thumbs/imperial-rest.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#38bdf8', glassColor: 'rgba(10,15,30,0.60)', menuBg: 'rgba(15,20,40,0.80)' },
  { id: 'live:blurred_sunset', name: 'Yağmurlu Gün Batımı', category: 'live', isVideo: true, video: './themes/live/blurred-sunset-while-raining.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/blurred-sunset-while-raining.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#fb923c', glassColor: 'rgba(30,15,10,0.60)', menuBg: 'rgba(40,20,15,0.80)' },
  { id: 'live:cartethyia', name: 'Cartethyia Yansımaları', category: 'live', isVideo: true, video: './themes/live/cartethyia-reflections-beneath.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/cartethyia-reflections-beneath.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#2dd4bf', glassColor: 'rgba(10,20,30,0.60)', menuBg: 'rgba(15,30,40,0.80)' },
  { id: 'live:evening_drive', name: 'Akşam Sürüşü', category: 'live', isVideo: true, video: './themes/live/evening-drive-and-windmills.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/evening-drive-and-windmills.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#c084fc', glassColor: 'rgba(20,10,30,0.60)', menuBg: 'rgba(30,15,40,0.80)' },
  { id: 'live:forest_creek', name: 'Orman Deresi', category: 'live', isVideo: true, video: './themes/live/forest-creek.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/forest-creek.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#4ade80', glassColor: 'rgba(10,25,15,0.60)', menuBg: 'rgba(15,35,20,0.80)' },
  { id: 'live:gamer_chisa', name: 'Oyuncu Chisa', category: 'live', isVideo: true, video: './themes/live/gamer-chisa-wuthering-waves.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/gamer-chisa-wuthering-waves.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#ec4899', glassColor: 'rgba(30,10,25,0.60)', menuBg: 'rgba(40,15,35,0.80)' },
  { id: 'live:jellyfish', name: 'Denizanaları', category: 'live', isVideo: true, video: './themes/live/jellyfish-swarm.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/jellyfish-swarm.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#a78bfa', glassColor: 'rgba(15,10,40,0.60)', menuBg: 'rgba(20,15,50,0.80)' },
  { id: 'live:lake_snowy', name: 'Karlı Zirveler', category: 'live', isVideo: true, video: './themes/live/lake-by-snowy-peaks.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/lake-by-snowy-peaks.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#93c5fd', glassColor: 'rgba(15,25,40,0.60)', menuBg: 'rgba(20,35,50,0.80)' },
  { id: 'live:lake_windy', name: 'Rüzgarlı Göl', category: 'live', isVideo: true, video: './themes/live/lake-on-windy-day.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/lake-on-windy-day.1920x1080.mp4', isLight: true, textColor: '#0F172A', accentColor: '#64748b', glassColor: 'rgba(220,230,240,0.50)', menuBg: 'rgba(230,240,250,0.84)' },
  { id: 'live:lucy_ww', name: 'Alevli Lucy', category: 'live', isVideo: true, video: './themes/live/lucy-wuthering-waves.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/lucy-wuthering-waves.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#ef4444', glassColor: 'rgba(35,10,10,0.60)', menuBg: 'rgba(45,15,15,0.80)' },
  { id: 'live:raindrop', name: 'Camda Yağmur', category: 'live', isVideo: true, video: './themes/live/raindrop-on-window.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/raindrop-on-window.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#94a3b8', glassColor: 'rgba(20,25,30,0.60)', menuBg: 'rgba(30,35,40,0.80)' },
  { id: 'live:shorekeeper', name: 'Shorekeeper', category: 'live', isVideo: true, video: './themes/live/shorekeeper-music-of-the-tides.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/shorekeeper-music-of-the-tides.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#0ea5e9', glassColor: 'rgba(10,20,45,0.60)', menuBg: 'rgba(15,30,60,0.80)' },
  { id: 'live:solitary', name: 'Yalnız Yansıma', category: 'live', isVideo: true, video: './themes/live/solitary-reflection.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/solitary-reflection.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#fcd34d', glassColor: 'rgba(25,20,10,0.60)', menuBg: 'rgba(35,30,15,0.80)' },
  { id: 'live:wave_symphony', name: 'Dalga Senfonisi', category: 'live', isVideo: true, video: './themes/live/wave-symphony.1920x1080.mp4', thumbnailVideo: './themes/live/thumbs/wave-symphony.1920x1080.mp4', isLight: false, textColor: '#FFFFFF', accentColor: '#0284c7', glassColor: 'rgba(5,20,35,0.60)', menuBg: 'rgba(10,30,50,0.80)' },

  // ── Chiikawa (Live) ──
  { id: 'live:chiikawa_1', name: 'Chiikawa 1', category: 'live', isVideo: true, video: './themes/live/chiikawa-1.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-1.mp4', isLight: true, textColor: '#0F172A', accentColor: '#f472b6', glassColor: 'rgba(255,240,245,0.50)', menuBg: 'rgba(255,245,250,0.84)' },
  { id: 'live:chiikawa_2', name: 'Chiikawa 2', category: 'live', isVideo: true, video: './themes/live/chiikawa-2.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-2.mp4', isLight: true, textColor: '#0F172A', accentColor: '#f472b6', glassColor: 'rgba(255,240,245,0.50)', menuBg: 'rgba(255,245,250,0.84)' },
  { id: 'live:chiikawa_3', name: 'Chiikawa 3', category: 'live', isVideo: true, video: './themes/live/chiikawa-3.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-3.mp4', isLight: true, textColor: '#0F172A', accentColor: '#f472b6', glassColor: 'rgba(255,240,245,0.50)', menuBg: 'rgba(255,245,250,0.84)' },
  { id: 'live:chiikawa_4', name: 'Chiikawa 4', category: 'live', isVideo: true, video: './themes/live/chiikawa-4.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-4.mp4', isLight: true, textColor: '#0F172A', accentColor: '#f472b6', glassColor: 'rgba(255,240,245,0.50)', menuBg: 'rgba(255,245,250,0.84)' },
  { id: 'live:chiikawa_5', name: 'Chiikawa 5', category: 'live', isVideo: true, video: './themes/live/chiikawa-5.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-5.mp4', isLight: true, textColor: '#0F172A', accentColor: '#f472b6', glassColor: 'rgba(255,240,245,0.50)', menuBg: 'rgba(255,245,250,0.84)' },
  { id: 'live:chiikawa_6', name: 'Chiikawa 6', category: 'live', isVideo: true, video: './themes/live/chiikawa-6.mp4', thumbnailVideo: './themes/live/thumbs/chiikawa-6.mp4', isLight: true, textColor: '#0F172A', accentColor: '#f472b6', glassColor: 'rgba(255,240,245,0.50)', menuBg: 'rgba(255,245,250,0.84)' },
  // ── Moon ──
